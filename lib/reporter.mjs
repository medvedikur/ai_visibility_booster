...
export function buildReportMarkdown({ domain, analysis, crawlStats, comparison, plugin }) {
  ...
  lines.push(`Plugin: ${plugin?.name || "ai-visibility-booster"} v${plugin?.version || "0.1.0"}`);
  ...
  lines.push(`## Caveats`);
  lines.push("");
  lines.push(`- This v0.1.0 score is a heuristic based on the 36 BASIC checks; it is not a Semrush AI Visibility score.`);
